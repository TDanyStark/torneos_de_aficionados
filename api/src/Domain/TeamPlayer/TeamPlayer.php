...
final class TeamPlayer implements JsonSerializable
{
    ...
    public static function fromRow(array $row): self
    {
        return new self(
            ...
            (string) $row['status'],
            isset($row['rejection_reason']) && $row['rejection_reason'] !== null ? (string) $row['rejection_reason'] : null,
            isset($row['rejected_at']) && $row['rejected_at'] !== null ? (string) $row['rejected_at'] : null,
